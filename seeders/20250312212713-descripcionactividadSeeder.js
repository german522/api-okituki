  ...
  async up(queryInterface, Sequelize) {
    return queryInterface.bulkInsert("Descripcion_Actividad", [
      ...
      },
      {
        ...
        id_actividad: 18, // Asegúrate de que exista este tipo de actividad
        numero_paso: 2,
        instruccion: "Ahora cinco sosas que sean círculos.",
        URL_imagen: ""
      },
      {
        id: 80,
        id_actividad: 18, // Asegúrate de que exista este tipo de actividad
        numero_paso: 3,
        instruccion: "Ahora cinco sosas que sean suaves.",
        URL_imagen: ""
      },
      {
        id: 81,
        id_actividad: 18, // Asegúrate de que exista este tipo de actividad
        numero_paso: 4,
        instruccion: "Ahora cinco sosas que quepan en su mano.",
        URL_imagen: ""
      },
      {
        id: 82,
        id_actividad: 18, // Asegúrate de que exista este tipo de actividad
        numero_paso: 5,
        instruccion: "Por último cinco sosas que lo hagan sentir seguro.",
        URL_imagen: ""
      },
      {
        id: 83,
        id_actividad: 18, // Asegúrate de que exista este tipo de actividad
        numero_paso: 6,
        instruccion: "Recuerda que puedes repetir las veces que sean necesarias y escoger las categorías que más te agraden, diferentes colores, texturas, etc.",
        URL_imagen: ""
      },
      {
        id: 84,
      ...
      },
      {
        ...
        id_actividad: 19, // Asegúrate de que exista este tipo de actividad
        numero_paso: 2,
        instruccion: "Camina sin detenerte durante diez minutos (puede ser en círculos si es un espacio pequeño).",
        URL_imagen: ""
      },
      {
        id: 86,
        id_actividad: 19, // Asegúrate de que exista este tipo de actividad
        numero_paso: 3,
        instruccion: "Concéntrate en lo que tus pies están sintiendo al caminar.",
        URL_imagen: ""
      },
      {
        id: 87,
      ...
      },
      {
        ...
        id_actividad: 20, // Asegúrate de que exista este tipo de actividad
        numero_paso: 3,
        instruccion: "Describe sus características, ¿ es agudo o grave?, ¿es constante o cambia con el tiempo?, ¿tiene un ritmo definido o es irregular?",
        URL_imagen: ""
      },
      {
        id: 91,
        id_actividad: 20, // Asegúrate de que exista este tipo de actividad
        numero_paso: 4,
        instruccion: "Intenta percibir variaciones en el sonido y distinguirlo de otros ruidos de fondo.",
        URL_imagen: ""
      },
    ]);
  },
